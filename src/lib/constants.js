...
export const feeOptionsByType = {
  "stx-ft": [
    { type: "stx", title: "1% in STX", contract: STX_FT_SWAP_FEE_CONTRACT },
    {
      type: "frie",
      title: "1% in FRIE",
      contract: STX_FT_SWAP_FRIE_FEE_CONTRACT,
    },
  ],
  "stx-nft": [
    { type: "stx", title: "1% in STX", contract: STX_NFT_SWAP_FEE_CONTRACT },
  ],
  "banana-nft": [
    {
      type: "banana",
      title: "1% in $BANANA",
      contract: BANANA_NFT_SWAP_FEE_CONTRACT,
    },
  ],
  "banana-ft": [
    {
      type: "banana",
      title: "1% in $BANANA",
      contract: BANANA_FT_SWAP_FEE_CONTRACT,
    },
  ],
  "satoshible-nft": [
    { type: "fixed", title: "5 STX", contract: SATOSHIBLE_SWAP_FEE_CONTRACT },
  ],
  "satoshible-ft": [
    { type: "fixed", title: "5 STX", contract: SATOSHIBLE_SWAP_FEE_CONTRACT },
  ],
  "usda-nft": [
    { type: "usda", title: "1% in USDA", contract: USDA_SWAP_FEE_CONTRACT },
  ],
  "usda-ft": [
    { type: "usda", title: "1% in USDA", contract: USDA_SWAP_FEE_CONTRACT },
  ],
  "xbtc-nft": [
    { type: "xbtc", title: "1% in xBTC", contract: XBTC_SWAP_FEE_CONTRACT },
  ],
  "xbtc-ft": [
    { type: "xbtc", title: "1% in xBTC", contract: XBTC_SWAP_FEE_CONTRACT },
  ],
